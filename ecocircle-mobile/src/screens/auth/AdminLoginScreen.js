...
/**
 * AdminLoginScreen - Mobile login screen for administrators
 * 
 * Ported from client/src/pages/login/AdminLogin.jsx:
 * - Dark green/shield theme admin graphics and demo box on tablets
 * - Login form with phone number, password, eye-toggle visibility, error alert
 * - Redirects dynamically to other portals (Resident, Driver)
              ...
              >
                ...
                <View style={styles.heroContentContainer}>
                  <View style={styles.heroLogoContainer}>
                    <MaterialCommunityIcons name="shield" size={36} color="#ffffff" />
                  </View>
                  ...
                  <View style={styles.benefitsList}>
                    {[
                      { step: '1', icon: 'chart-bar', text: 'Monitor collection reports & statistics' },
                      { step: '2', icon: 'map-marker-outline', text: 'Visualize & optimize collection routes' },
                      { step: '3', icon: 'account-group-outline', text: 'Manage drivers, households & assignments' },
                    ].map((item, idx) => (
                  ...
                  <View style={styles.demoBox}>
                    ...
                    <View style={styles.demoRow}>
                      ...
                      <Text style={styles.demoValue}>9999999999</Text>
                    </View>
                    <View style={styles.demoRow}>
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.titleRow}>
                <View style={styles.brandIconBg}>
                  <MaterialCommunityIcons name="shield" size={20} color="#1b4332" />
                </View>
                <Text style={styles.titleText}>Admin Sign In</Text>
              </View>
              <Text style={styles.subtitleText}>Municipality waste management control panel</Text>
                ...
                >
                  {loading ? (
                    ...
                    <View style={styles.submitButtonRow}>
                      ...
                      <Text style={styles.submitButtonText}>Sign In as Admin</Text>
                    </View>
                  )}
                </TouchableOpacity>
              ...
              {!isLargeScreen && (
                <View style={styles.mobileDemoBox}>
                  ...
                  <Text style={styles.mobileDemoText}><Text style={styles.mobileDemoLabel}>Phone: </Text>9999999999 / admin123</Text>
                </View>
              )}
