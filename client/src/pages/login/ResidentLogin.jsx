...
import { Recycle, Phone, Lock, Eye, EyeOff, LogIn, Home, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        />
        <div className="absolute inset-0 bg-[#2d6a4f]/80" />
        <div className="relative z-10 h-full flex flex-col items-center justify-center p-12 text-center text-white">
          ...
          <h2 className="text-3xl font-bold mb-3">Resident Portal</h2>
          ...
          <div className="mt-10 space-y-3 text-left text-sm w-full max-w-xs">
            <div className="flex items-start gap-3 text-stone-200">
              ...
              <span>Report daily garbage for pickup</span>
            </div>
            <div className="flex items-start gap-3 text-stone-200">
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-xs font-bold">2</span>
              </div>
              <span>Track collection status in real-time</span>
            </div>
            <div className="flex items-start gap-3 text-stone-200">
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-xs font-bold">3</span>
              </div>
              <span>Earn green points &amp; climb reward tiers</span>
            </div>
          </div>
          ...
          <div className="mt-10 bg-white/10 rounded-xl p-5 text-left text-sm w-full max-w-xs">
            ...
            <p className="text-stone-300"><span className="text-white font-medium">Phone:</span> 7000000000</p>
            <p className="text-stone-300"><span className="text-white font-medium">Password:</span> user123</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#fafaf8]">
        <div className="w-full max-w-md">
          <Link to="/" className="inline-flex items-center gap-2 text-sm text-stone-500 hover:text-[#2d6a4f] mb-8 transition-colors">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-stone-900">Resident Sign In</h1>
            </div>
          </div>
          <p className="text-stone-500 mb-8 ml-[52px]">Access your household waste management portal</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border border-stone-300 rounded-lg bg-white focus:ring-2 focus:ring-[#2d6a4f]/20 focus:border-[#2d6a4f] transition-all outline-none"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border border-stone-300 rounded-lg bg-white focus:ring-2 focus:ring-[#2d6a4f]/20 focus:border-[#2d6a4f] transition-all outline-none"
          ...
          <div className="lg:hidden mt-6 bg-white border border-stone-200 rounded-lg p-4 text-sm text-stone-600">
            ...
            <p>Phone: 7000000000 / Password: user123</p>
          </div>
        </div>
      </div>
    </div>
