...
import { Truck, Phone, Lock, Eye, EyeOff, LogIn, ArrowLeft, MapPin, Navigation } from 'lucide-react';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center p-12 text-center text-white">
          ...
          <h2 className="text-3xl font-bold mb-3">Driver Portal</h2>
          ...
          <div className="mt-10 space-y-3 text-left text-sm w-full max-w-xs">
            ...
            <div className="flex items-start gap-3 text-stone-200">
              ...
              <span>Navigate to stops with Google Maps</span>
            </div>
            <div className="flex items-start gap-3 text-stone-200">
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <Truck className="w-3 h-3" />
              </div>
              <span>Mark collections &amp; update statuses</span>
            </div>
          </div>
          ...
          <div className="mt-10 bg-white/10 rounded-xl p-5 text-left text-sm w-full max-w-xs">
            ...
            <p className="text-stone-300"><span className="text-white font-medium">Phone:</span> 8000000001</p>
            <p className="text-stone-300"><span className="text-white font-medium">Password:</span> driver123</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#fafaf8]">
        <div className="w-full max-w-md">
          <Link to="/" className="inline-flex items-center gap-2 text-sm text-stone-500 hover:text-[#52796f] mb-8 transition-colors">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-stone-900">Driver Sign In</h1>
            </div>
          </div>
          <p className="text-stone-500 mb-8 ml-[52px]">Access your route assignments and collection dashboard</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border border-stone-300 rounded-lg bg-white focus:ring-2 focus:ring-[#52796f]/20 focus:border-[#52796f] transition-all outline-none"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border border-stone-300 rounded-lg bg-white focus:ring-2 focus:ring-[#52796f]/20 focus:border-[#52796f] transition-all outline-none"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#52796f] text-white font-semibold rounded-lg hover:bg-[#3e5c54] transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
            >
              {loading ? (
          ...
          <div className="mt-8 pt-6 border-t border-stone-200">
            ...
            <div className="flex gap-3">
              ...
              <Link to="/login/admin" className="flex-1 text-center py-2.5 text-sm font-medium text-stone-600 bg-white border border-stone-200 rounded-lg hover:border-[#1b4332] hover:text-[#1b4332] transition-colors">
                Admin Login
              </Link>
            </div>
          </div>
          ...
          <div className="lg:hidden mt-6 bg-white border border-stone-200 rounded-lg p-4 text-sm text-stone-600">
            ...
            <p>Phone: 8000000001 / Password: driver123</p>
          </div>
        </div>
      </div>
    </div>
